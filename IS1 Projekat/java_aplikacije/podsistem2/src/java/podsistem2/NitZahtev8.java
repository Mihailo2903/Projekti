...
public class NitZahtev8 extends Thread {
    ...
    public void run() {
        ...
        JMSConsumer consumer = context.createConsumer(queue2, "Broj = 88");
        ...
        while (true) {
            try {
                ...
                String odgovor = "Uplata uspesno izvrsena";
                ...
                if (listaRac.isEmpty()) {
                    ...
                    try {
                        ...
                        if (rac.getStatus().equals("Z")) {
                            odgovor = "Racun na koji se vrsi uplata je zatvoren";
                        } 
                        else {
                            ...
                            u.setIdTransakcija(l.get(0).getIdTransakcija());
