...
public class NitZahtev4 extends Thread {
    ...
    public void run() {
        ...
        JMSConsumer consumer = context.createConsumer(queue1, "Broj = 4");
        ...
        while (true) {
            try {
                ...
                String odgovor;
                odgovor = "Zamena uspesno izvrsena";
                ...
                if (listaMes.isEmpty() && listaKom.isEmpty()) {
                    odgovor= "Nema komitenta sa tim imenom?Nema mesta sa tim imenom";
                    System.out.println(odgovor);
                    em.close();
                }
                
                else if(listaKom.isEmpty()){
                    odgovor= "Nema komitenta sa tim imenom";
                    em.close();
                }
                
                else if(listaMes.isEmpty()){
                    odgovor= "Nema mesta sa tim imenom";
                    em.close();
                }
                   ...
                   try {
                        ...
                        if (em.getTransaction().isActive()) {
                            ...
                            odgovor = "Nije uspela promena sedista";
                        }
                        em.close();
                    }
                }
