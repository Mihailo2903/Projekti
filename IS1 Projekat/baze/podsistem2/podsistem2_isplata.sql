...
CREATE TABLE `isplata` (
  ...
  CONSTRAINT `FK_Isplata_IdTransakcija` FOREIGN KEY (`IdTransakcija`) REFERENCES `transakcija` (`IdTransakcija`) ON UPDATE CASCADE
...
INSERT INTO `isplata` VALUES (2,5),(5,3),(15,3);
