...
CREATE TABLE `filijala` (
  ...
  CONSTRAINT `FK_Filijala_IdMesto` FOREIGN KEY (`IdMesto`) REFERENCES `mesto` (`IdMesto`)
...
INSERT INTO `filijala` VALUES (1,'Fili Pp1','Ulica42 33',4),(2,'Fili Zr1','Ulica33 63',6),(3,'Fili Ue1','Ulica53 42',5),(4,'Fili Ni1','Ulica32 11',3),(5,'Fili Bg1','Ulica190 111',1),(6,'Fili Ue2','Ulica50 43',5),(7,'Fili Ni2','Ulica31 22',3),(8,'Fili Zr2','Ulica665 33',6);
