...
public class DesignStatementOperation extends DesignatorStatement {

    private Designator Designator;
    private DesignatorOperation DesignatorOperation;

    public DesignStatementOperation (Designator Designator, DesignatorOperation DesignatorOperation) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignStatementOperation(\n");
