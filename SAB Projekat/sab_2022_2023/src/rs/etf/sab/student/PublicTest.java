...
public class PublicTest {
    ...
    public void setUp() throws Exception {
        this.articleOperations = new tm190185_ArticleOperations(); // Change this for your implementation (points will be negative if interfaces are not implemented).
        this.buyerOperations = new tm190185_BuyerOperations();
        this.cityOperations = new tm190185_CityOperations();
        this.generalOperations = new tm190185_GeneralOperations();
        this.orderOperations = new tm190185_OrderOperations();
        this.shopOperations = new tm190185_ShopOperations();
        this.transactionOperations = new tm190185_TransactionOperations();
